...
mongoose.connect(CONNECTION_URL, { useNewUrlParser: true, useUnifiedTopology: true}).then(() => app.listen(3001, () => console.log("Servr"))).catch((error) => console.log(error.message));
